...
st.header('SQL Buddy: Aggregator-inator')
st.subheader('Please copy in your list of data to either add an aggregation function or to convert it into table notation.')
